...
Este documento está concebido como un acompañamiento teórico para quien dicte la Unidad 5 sobre Alfabetización en Inteligencia Artificial. No reemplaza las slides ni las repite, sino que las expande en profundidad conceptual, contexto histórico, fundamentos técnicos y orientaciones pedagógicas. La intención es que el docente llegue al aula con un dominio claro de los temas, anticipe las preguntas más frecuentes y pueda contextualizar cada hito en su trama histórica y técnica.
